...
export const recentSalesTableDemoData = [
  {
    name: 'Desarrollador Jr MoviiRed',
    price: '$1500.00',
  ...
  {
    name: 'Desarrollador Web Front (React,angular,Vuejs)',
    price: '$2700.00',
    timestamp: now.clone().subtract(14, 'minutes').fromNow(),
  },
  {
    name: 'Comercial freelance',
    price: '$2500.00',
    timestamp: now.clone().subtract(17, 'minutes').fromNow(),
  },
  {
    name: 'Developer - 100% Remote',
    price: '$1600.00',
  ...
  {
    name: 'Desarrollador(a) Flutter',
    price: '$11000.00',
    timestamp: now.clone().subtract(104, 'minutes').fromNow(),
  },
  {
    name: 'Desarrollador(a) Android',
    price: '$5400.00',
